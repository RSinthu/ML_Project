...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Entered the data ingestion component or the component")
        try:
            # Use correct path to the CSV file
            csv_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'gemstone.csv')
